...
Route::get('/', function () {
    return view('welcome');   // halaman awal biasa
});
// 🔹 User biasa
...
require __DIR__ . '/auth.php';
Route::get('/dashboard-group-consolidation', [AdminController::class, 'dashboardAdmin'])->name('adminGroupConsolidation');
Route::get('/dashboard-data-consolidation', [AdminController::class, 'dashboardAdmin'])->name('adminDataConsolidation');
Route::get('/dashboard-company-ownership', [AdminController::class, 'dashboardAdmin'])->name('adminCompanyOwnership');
Route::get('/dashboard-sra', [AdminController::class, 'dashboardAdmin'])->name('adminSra');
